...
terraform {
  ...
  backend "s3" {
    bucket         = "cmh-ahroc-codebuild-terraform-tfstate"
...
module "bootstrap" {
  ...
  s3_tfstate_bucket                   = "cmh-ahroc-codebuild-terraform-tfstate"
  s3_logging_bucket_name              = "cmh-ahroc-codebuild-logging-bucket"
...
module "codepipeline" {
  ...
  tf_codepipeline_artifact_bucket_name = "cmh-ahroc-codebuild-artifact-bucket-name"
